...
See [`packages/frontend/AGENTS.md`](packages/frontend/AGENTS.md) for frontend architecture, conventions, and styling.
...
Vitest for both packages. Backend integration tests start an in-process server — no mocking of the database. WebSocket tests use an in-process WS client against a seeded DB. See [`packages/frontend/AGENTS.md`](packages/frontend/AGENTS.md) for frontend testing details.
